...
>
> 采用激光雕刻透明亚克力板作为上盖板，厚度为1mm
>
> ![](Image/L-ink_V0.6.jpg)
>
> 修改了按钮的结构，使得固定更加稳固
>
> 左侧为simonire设计，五向开关嵌入按钮的部分太短，按键手感较差
>
> ![](Image/button.JPG)
> 
> 
...
### simonire没有放出修改后的原理图，后续希望能在保留4张卡的基础上，优化pcb封装。如TPS61221、LED等，统一阻容封装为0402或0603。 
...
> 微雪1.54寸墨水屏200x200分辨率，fpc座应采用24p-0.5mm下接。
